                ...
                <div class="row">
                    <div class="col-md-6 copy-right">
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Booking Core by')); ?> <a
                            href="<?php echo e(__('https://www.reecesoftwares.xyz')); ?>" target="_blank"
                        ><?php echo e(__('Daptex Innovations')); ?></a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="<?php echo e(__('https://www.reecesoftwares.xyz')); ?>" target="_blank"><?php echo e(__('About Us')); ?></a>
                            <a href="<?php echo e(__('https://www.reecesoftwares.xyz')); ?>" target="_blank"><?php echo e(__('Contact Us')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\BookingCore\modules/Layout/admin/app.blade.php ENDPATH**/ ?>