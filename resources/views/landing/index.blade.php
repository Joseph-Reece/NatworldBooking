...
<head>
    <meta charset="UTF-8"/>
    <title>Nature - Ultimate Tour Providers</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://reecesoftwares.xyz" target="_blank">Support</a>
                            <a target="_blank" class="dropdown-item" href="https://reecesoftwares.xyz">Documentation</a>
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a target="_blank" href="https://reecesoftwares.xyz">Support</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://reecesoftwares.xyz">Documentation</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="social">
            ...
            <ul>
                ...
                <li>
                    <a href="mailto:contact@reecesoftwares.xyz">
